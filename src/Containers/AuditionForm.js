    ...
    render(){
        ...
        return(
            <form className="audition-form"  onSubmit={this.handleSubmit}>
                ...
                <span>(If the song you sang is NOT in your song book, you should add the song to your song book, or click "Other" and make a note at the bottom of the page regarding the sides you sang)</span>
